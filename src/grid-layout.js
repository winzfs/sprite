...
function loadMediaToolHelpers() {
  loadBackgroundRemoverHelpers()
    ...
    .then(() => loadScriptOnce('src/sfx-premium-engine.js?v=1', 'sfx-premium-engine'))
    .then(() => loadScriptOnce('src/sfx-modern-texture-engine.js?v=1', 'sfx-modern-texture-engine'));
}
