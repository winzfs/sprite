(() => {
  ...
  function ensureStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      #view-sfxMaker.sfx-studio-view { --studio-accent:#06b6d4; --studio-violet:#7c3aed; --studio-bg:#020617; }
      ...
      @media (max-width:640px) { .sfx-macro-deck { grid-template-columns:1fr; } .sfx-category-bar { margin-left:-2px; margin-right:-2px; } #view-sfxMaker.sfx-studio-view .sfx-transport { background:transparent; border:0; padding:0; } }
